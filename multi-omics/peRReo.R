...
latin_palettes = list(
  aventura=c("#284C46","#B3B177","#E18964","#192E27","#A8B4A3","#AE5D40","#38190A","#4E6253","#000000"),
  ...
  eminem=c("#04101D","#1B768F","#8CBE63","#74131D","#1D3A1B","#AC4051","#102347","#226D37","#494347"),
  ...
  rauw=c("#E02331","#350275","#15BBF3","#ED852F","#75E1F6","#8D2063","#DEAA7C","#107D6E","#241119"),
